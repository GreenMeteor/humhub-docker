...
This Dockerfile sets up a PHP 8.3.6 Apache environment and installs HumHub 1.15.5.
...
1. **Base Image**: Uses `php:8.3.6-apache` as the base image.
...
4. **HumHub Installation**:
   - Downloads HumHub version 1.15.5 using `curl`.
